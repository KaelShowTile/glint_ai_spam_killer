...
class Glint_AI_Interceptor {
	...
	public static function init() {
		add_filter( 'pre_wp_mail', array( __CLASS__, 'intercept_mail' ), 10, 1 );
	}

	public static function intercept_mail( $atts ) {
